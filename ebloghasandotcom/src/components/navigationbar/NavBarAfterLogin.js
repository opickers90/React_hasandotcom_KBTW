...
class NavBarAfterLogin extends React.Component {
    constructor(props) {
        super(props);
                ...
                <div className="flyout">
                    ...
                    <Footer color="blue">
                        <p className="footer-copyright mb-0 py-3 text-center">
                            ...
                            <a href="https://www.instagram.com/asanazam07/?utm_source=ig_profile_share&igshid=pdckrlsxupay"> hasandotcom </a>
                        </p>
                    </Footer>
                </div>
            </Router>
